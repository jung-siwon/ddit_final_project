...
<!-- 		                                    <h6 class="mb-4 text-secondary">보류 ()</h6> -->
                            ...
                            <div class="tab-pane fade <c:if test="${active eq '5' }">show active</c:if>" id="calendar" role="tabpanel" aria-labelledby="calendar-tab" style="background:white;">
                            <div  id="calendar">
                            <!--//Page content//-->
...
<!-- 											                                  <img src="/resources/assets/media/icons/files/css.svg" class="height-40 me-3 flex-shrink-0 w-auto" alt=""> -->
											                                  <div class="flex-grow-1 overflow-hidden">
											                                    ...
											                                    <div class="d-flex align-items-center justify-content-between">
											                                      <small class="text-body-secondary">${cooFormFile.attatchSize }KB</small>
											                                      <a href="#!" class="text-body"
